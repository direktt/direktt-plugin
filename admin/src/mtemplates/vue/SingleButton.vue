...
<template>
    <div style="width:100%">
        ...
        <div class="mb-4"><strong>Action Type:</strong> <v-spacer></v-spacer>
            <select v-model="props.btn.action.type" style="border-style:solid; border-color: #666;">
        ...
        <div v-if="props.btn.action.type == 'link'" class="pb-4 actionDiv">
            ...
            <div class="mb-4"><strong>Target:</strong> <v-spacer></v-spacer>
                <select v-model="btn.action.params.target" style="border-style:solid; border-color: #666;">
        ...
        <div v-if="props.btn.action.type == 'chat'" class="pb-4 actionDiv">
            <div class="mb-2"><strong>User Subscription Id:</strong> <v-text-field
                    v-model="btn.action.params.subscriptionId" variant="outlined"></v-text-field></div>
        </div>
