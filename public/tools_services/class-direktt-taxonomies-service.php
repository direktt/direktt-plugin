...
class Direktt_Taxonomies_Service {
    ...
    static function direktt_taxonomies_service_shortcode() {
        ...
        if ( $subpage ) {
            ...
            ?>
            <p><a href="<?php echo esc_url( $backUri ); ?>"><?php echo esc_html__( 'All Taxonomies', 'direktt' ); ?></a></p>
            <?php
            ...
            ?>
            <div class="direktt-edit-taxonomies-service-wrapper">
                <div class="direktt-edit-taxonomies-service-categories">
                    ...
                    foreach ( $all_categories as $category ) {
                        ...
                        ?>
                        <p><a href="<?php echo esc_url( $newUri ); ?>"><?php echo esc_html( $category['name'] ); ?></a><?php echo ' [' . esc_html( $count ) . ']'; ?></p>
                        <?php
                    }
                    ?>
                </div>
                <div class="direktt-edit-taxonomies-service-tags">
                    ...
                    foreach ( $all_tags as $tag ) {
                        ...
                        ?>
                        <p><a href="<?php echo esc_url( $newUri ); ?>"><?php echo esc_html( $tag['name'] ); ?></a><?php echo ' [' . esc_html( $count ) . ']'; ?></p>
                        <?php
                    }
                    ?>
                </div>
