...
class Direktt_Bulk_Messaging_Service {
    public function direktt_bulk_messaging_service_add_shortcode() {
        add_shortcode( 'direktt_bulk_messaging_service', [ $this, 'direktt_bulk_messaging_service_shortcode' ] );
    }
    static function direktt_register_bulk_messaging_service_scripts() {
        wp_register_style( 'jquery-ui-css', 'https://code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css' );
    }
    
    static function direktt_bulk_messaging_service_shortcode() {
        ...
        if ( $subpage ) {
            ...
            ?>
				<div id="direktt-profile-wrapper">
					<div class="direktt-bulk-messaging-service-wrapper direktt-bulk-messaging-service-editor" id="direktt-profile">
					<?php
