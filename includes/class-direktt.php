...
class Direktt {
	...
	private function load_dependencies() {
		...
		require_once plugin_dir_path( __DIR__ ) . 'public/class-direktt-api.php';

		require_once plugin_dir_path( __DIR__ ) . 'public/class-direktt-profile.php';

		require_once plugin_dir_path( __DIR__ ) . 'public/profile-bar/class-direktt-taxonomies-tool.php';

		require_once plugin_dir_path( __DIR__ ) . 'public/profile-bar/class-direktt-messaging-tool.php';

		require_once plugin_dir_path( __DIR__ ) . 'public/profile-bar/class-direktt-notes-tool.php';

		require_once plugin_dir_path( __DIR__ ) . 'public/tools-services/class-direktt-taxonomies-service.php';

		require_once plugin_dir_path( __DIR__ ) . 'public/tools-services/class-direktt-bulk-messaging-service.php';

		require_once plugin_dir_path( __DIR__ ) . 'admin/class-direktt-admin.php';

		require_once plugin_dir_path( __DIR__ ) . 'admin/class-direktt-event.php';

		require_once plugin_dir_path( __DIR__ ) . 'admin/class-direktt-user.php';

		require_once plugin_dir_path( __DIR__ ) . 'admin/class-direktt-ajax.php';

		require_once plugin_dir_path( __DIR__ ) . 'admin/class-direktt-message.php';
